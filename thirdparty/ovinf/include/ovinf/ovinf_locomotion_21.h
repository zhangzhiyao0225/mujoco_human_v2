#ifndef OVINF_LOCOMOTION_21_H
#define OVINF_LOCOMOTION_21_H
...
namespace ovinf
{
  ...
  class Locomotion21Policy : public BasePolicy<float>
  {
  ...
  public:
    Locomotion21Policy() = delete;
    ~Locomotion21Policy();

    Locomotion21Policy(const YAML::Node &config);
  ...
  private:
    VectorT arm_ref_target_;

    VectorT arm_ref_action_;

  public:
    const VectorT &GetArmRefTarget() const { return arm_ref_target_; }
  };
} // namespace ovinf
